...
using System;
    public class timeNtp : MonoBehaviour
    {
        void Start()
        {
            GetNetworkTime();
    ...
    public static System.DateTime GetNetworkTime()
        {
            //—сылка на наш ntp сервер
            const string ntpServer = "ua.pool.ntp.org";

            //–азмер данных, получаемых от ntp сервера
        ...
        //переводим врем€ в **UTC**
           ...
           string timetotime = networkDateTime.ToLocalTime().ToString();
           //print(timetotime);
           //return milliseconds;
